 ...
 * @author kulas
 */
public class homeFrame_cashier1 extends javax.swing.JFrame {

    /**
     * Creates new form dashBoardFrame
     */
    static Logger log1 = Logger.getLogger(homeFrame_cashier1.class.getName());
    
    public homeFrame_cashier1() {
        initComponents();
    ...
    private void customerMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_customerMouseClicked
        new GUI.Customer.customerFrame_cashier1().setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(homeFrame_cashier1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new homeFrame_cashier1().setVisible(true);
            }
        });
    }
