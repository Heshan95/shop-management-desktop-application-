 ...
 * @author kulas
 */
public class homeFrame_cashier2 extends javax.swing.JFrame {

    /**
     * Creates new form dashBoardFrame
     */
    static Logger log1 = Logger.getLogger(homeFrame_cashier2.class.getName());
    
    public homeFrame_cashier2() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(homeFrame_cashier2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new homeFrame_cashier2().setVisible(true);
            }
        });
    }
