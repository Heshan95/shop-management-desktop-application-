 ...
 * @author kulas
 */
public class backup_restoreFrame_cashier2 extends javax.swing.JFrame {

    /**
     * Creates new form dashBoardFrame
     */
    static Logger log1 = Logger.getLogger(backup_restoreFrame_cashier2.class.getName());
    
    public backup_restoreFrame_cashier2() {
        initComponents();
...
void showDate(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(backup_restoreFrame_cashier2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new backup_restoreFrame_cashier2().setVisible(true);
            }
        });
    }
