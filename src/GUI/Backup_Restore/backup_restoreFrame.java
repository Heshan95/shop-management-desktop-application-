 ...
 * @author kulas
 */
public class backup_restoreFrame extends javax.swing.JFrame {

    /**
     * Creates new form dashBoardFrame
     */
    static Logger log1 = Logger.getLogger(backup_restoreFrame.class.getName());
    
    public backup_restoreFrame() {
        initComponents();
...
void showDate(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(backup_restoreFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new backup_restoreFrame().setVisible(true);
            }
        });
    }
