 ...
 * @author kulas
 */
public class customerFrame_cashier2 extends javax.swing.JFrame {

    /**
     * Creates new form dashBoardFrame
     */
    static Logger log1 = Logger.getLogger(customerFrame_cashier2.class.getName());
    
    private userModel um;
    DefaultTableModel userTableModel;

    public customerFrame_cashier2() {
        initComponents();
...
//       this.update();
    ...
    private void addSalesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addSalesMouseClicked
        // TODO add your handling code here:
        new GUI.AddSales.addSalesFrame_cashier2().setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(customerFrame_cashier2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new customerFrame_cashier2().setVisible(true);
            }
        });
    }
