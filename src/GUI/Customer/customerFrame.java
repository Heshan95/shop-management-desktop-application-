...
public class customerFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        addCustomerBtn.setFont(new java.awt.Font("Segoe UI Symbol", 1, 14)); // NOI18N
        ...
        jPanel1.add(addCustomerBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 130, 190, 30));
        ...
        jPanel1.add(keyWordField, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 133, 150, 20));
        ...
        jPanel1.add(update, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 600, 100, 30));
        ...
        jPanel1.add(removeBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(1040, 600, 100, 30));
        ...
        jPanel1.add(update1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 600, 230, 30));
...
//       this.update();
    ...
    private void removeBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeBtnActionPerformed
        //String idproducts = productIdField.getText();
        // String result = um.deleteProduct(idproducts);

       // JOptionPane.showConfirmDialog(rootPane, result, result, -1, 1);
        // um.loadTableData("", userTableModel);
        int row = customerTable.getSelectedRow();
        Object o1 = customerTable.getValueAt(row, 0);
        String id = String.valueOf(o1);
        String query = "DELETE FROM customer where customer_barcode = ? ";
        try {
