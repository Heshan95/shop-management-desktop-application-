 ...
 * @author kulas
 */
public class addSalesFrame_cashier1 extends javax.swing.JFrame {

    static Logger log1 = Logger.getLogger(addSalesFrame_cashier1.class.getName());
    /**
     * Creates new form dashBoardFrame
     */
    public addSalesFrame_cashier1() {
        initComponents();
        autoId();
...
log1.debug(e.getMessage());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addSalesFrame_cashier1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new addSalesFrame_cashier1().setVisible(true);
            }
        });
    }
    ...
    public static void invoice_save() {
        try {
            ...
            GUI.AddSales.addSalesFrame_cashier1.fullclear();
        } catch (Exception e) {
            e.printStackTrace();
            log1.debug(e.getMessage());
        }
