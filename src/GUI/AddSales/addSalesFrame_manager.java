 ...
 * @author kulas
 */
public class addSalesFrame_manager extends javax.swing.JFrame {

    /**
     * Creates new form dashBoardFrame
     */
    static Logger log1 = Logger.getLogger(addSalesFrame_manager.class.getName());
    
    public addSalesFrame_manager() {
        initComponents();
        autoId();
...
log1.debug(e.getMessage());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addSalesFrame_manager.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new addSalesFrame_manager().setVisible(true);
            }
        });
    }
    ...
    public static void invoice_save() {
        try {
            ...
            GUI.AddSales.addSalesFrame_manager.fullclear();
        } catch (Exception e) {
            e.printStackTrace();
            log1.debug(e.getMessage());
        }
