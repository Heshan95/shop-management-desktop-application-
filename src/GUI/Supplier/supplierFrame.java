...
public class supplierFrame extends javax.swing.JFrame {
     ...
     */
    static Logger log1 = Logger.getLogger(supplierFrame.class.getName());
    ...
    public static void suppliersTableLoad() {
        try {
            ...
            dtm.setRowCount(0);
            ResultSet rs = DB.dbConnection.getConnection().createStatement().executeQuery("SELECT * FROM suppliers join company on suppliers.company_id_company=company.id_company");
            while (rs.next()) {
                Vector v = new Vector();
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(updateBtn, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
