...
public class itemsFrame extends javax.swing.JFrame {
     ...
     */
    static Logger log1 = Logger.getLogger(itemsFrame.class.getName());
    ...
    public static void loadProductTable() {
        try {
            DefaultTableModel dtm = (DefaultTableModel) itemsFrame.itemTable.getModel();
            dtm.setRowCount(0);
    ...
    private void initComponents() {
        ...
        itemTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Product Barcode", "Category", "Item", "text", "Price", "Qty"
            }
        ) {
        ...
        if (itemTable.getColumnModel().getColumnCount() > 0) {
            ...
            itemTable.getColumnModel().getColumn(3).setPreferredWidth(0);
            ...
            itemTable.getColumnModel().getColumn(5).setMinWidth(50);
            itemTable.getColumnModel().getColumn(5).setPreferredWidth(50);
            itemTable.getColumnModel().getColumn(5).setMaxWidth(50);
        }
    ...
    private void updateBtn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtn1ActionPerformed
        new updateProducts(this, rootPaneCheckingEnabled).setVisible(true);
    ...
    public static void update() {
        ...
        updateProducts.bacordField.setText(dtm.getValueAt(itemTable.getSelectedRow(), 0).toString());
        updateProducts.jComboBox1.setSelectedItem(dtm.getValueAt(itemTable.getSelectedRow(), 1).toString());
        updateProducts.name.setText(dtm.getValueAt(itemTable.getSelectedRow(), 2).toString());
        updateProducts.textArea.setText(dtm.getValueAt(itemTable.getSelectedRow(), 3).toString());
        updateProducts.uPrice.setText(dtm.getValueAt(itemTable.getSelectedRow(), 4).toString());
        updateProducts.qty.setText(dtm.getValueAt(itemTable.getSelectedRow(), 5).toString());
